      ...
      <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
        ...
        <div className="md:text-right">
          ...
          <div className="flex gap-2 justify-start md:justify-end">
            <a href="https://github.com/YOUR_GITHUB_USERNAME" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="w-10 h-10 rounded-md bg-slate-800 text-slate-200 hover:bg-cyan-600 hover:text-slate-900 flex items-center justify-center">
            ...
            <a href="https://linkedin.com/in/YOUR_PROFILE" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="w-10 h-10 rounded-md bg-slate-800 text-slate-200 hover:bg-cyan-600 hover:text-slate-900 flex items-center justify-center">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
                <path d="M19 0h-14c-2.76 0-5 2.24-5 5v14c0 2.76 2.24 5 5 5h14c2.76 0 5-2.24 5-5v-14c0-2.76-2.24-5-5-5zm-11 19h-3v-10h3v10zm-1.5-11.27c-.97 0-1.75-.79-1.75-1.75s.78-1.75 1.75-1.75 1.75.79 1.75 1.75-.78 1.75-1.75 1.75zm13.5 11.27h-3v-5.5c0-1.32-1.09-2.25-2.25-2.25s-2.25.93-2.25 2.25v5.5h-3v-10h3v1.36c.88-1.3 2.64-1.36 3.62-.13 1.28 1.6 1.21 3.77 1.21 3.77v5z" />
              </svg>
            </a>
            
            <a href="https://twitter.com/YOUR_TWITTER" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="w-10 h-10 rounded-md bg-slate-800 text-slate-200 hover:bg-cyan-600 hover:text-slate-900 flex items-center justify-center">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
            ...
            <a href="https://leetcode.com/YOUR_USERNAME" target="_blank" rel="noopener noreferrer" aria-label="LeetCode" className="w-10 h-10 rounded-md bg-slate-800 text-slate-200 hover:bg-cyan-600 hover:text-slate-900 flex items-center justify-center">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
                <path d="M21 3H3v18h18V3zM9.5 17.5l-1.4-1.4L13.2 11l1.4 1.4L9.5 17.5zM16.5 9.5L12 5v2.5l3.5 3.5V9.5z" />
              </svg>
            </a>

            <a href="https://facebook.com/YOUR_PROFILE" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-10 h-10 rounded-md bg-slate-800 text-slate-200 hover:bg-cyan-600 hover:text-slate-900 flex items-center justify-center">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
                <path d="M22 12a10 10 0 1 0-11.5 9.9v-7h-2.2v-2.9h2.2V9.3c0-2.2 1.3-3.4 3.3-3.4.95 0 1.95.17 1.95.17v2.14h-1.1c-1.1 0-1.45.69-1.45 1.4v1.66h2.47l-.4 2.9H15v7A10 10 0 0 0 22 12" />
              </svg>
            </a>

            <a href="https://discord.gg/YOUR_INVITE" target="_blank" rel="noopener noreferrer" aria-label="Discord" className="w-10 h-10 rounded-md bg-slate-800 text-slate-200 hover:bg-cyan-600 hover:text-slate-900 flex items-center justify-center">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
                <path d="M20.1 3H3.9A1.9 1.9 0 0 0 2 4.9v10.2A1.9 1.9 0 0 0 3.9 17h11.3l-0.5-1.7 1.2 1 1.1 0.9 1.9 1.4V4.9A1.9 1.9 0 0 0 20.1 3zM8.6 12.1c-0.9 0-1.6-0.8-1.6-1.7s0.7-1.7 1.6-1.7c0.9 0 1.6 0.8 1.6 1.7s-0.7 1.7-1.6 1.7zm6.8 0c-0.9 0-1.6-0.8-1.6-1.7s0.7-1.7 1.6-1.7c0.9 0 1.6 0.8 1.6 1.7s-0.7 1.7-1.6 1.7z" />
              </svg>
            </a>
          </div>
        </div>
